      ...
      <nav className="sticky-nav flex justify-between flex-wrap items-center max-w-4xl w-full p-8 my-0 md:my-8 mx-auto bg-white dark:bg-black bg-opacity-60">
        ...
        >
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            <NextLink href="/">
              <a className="lg:inline-flex lg:w-auto w-full px-2 py-2 ml-2 rounded text-white font-bold items-center justify-center hover:bg-gray-200 hover:text-black sm:p-2 text-gray-900 dark:text-gray-100 dark:hover:bg-gray-800 self-end">
                Home
              </a>
            </NextLink>
            <NextLink href="/snippets">
              <a className="lg:inline-flex lg:w-auto w-full px-2 py-2 ml-2 rounded text-white font-bold items-center justify-center hover:bg-gray-200 hover:text-black p-1 sm:p-2 text-gray-900 dark:text-gray-100 dark:hover:bg-gray-800 self-end">
                Snippets
              </a>
            </NextLink>
            <NextLink href="/about">
            ...
            <button
              ...
              type="button"
              className="bg-gray-200 dark:bg-gray-800 rounded ml-2 mt-2 p-3 h-10 w-10 focus:outline-none"
